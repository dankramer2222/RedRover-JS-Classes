...
// Вопрос: Какой вариант правильно использует методы строк в JavaScript для обработки текста, чтобы получить текст в нижнем регистре с заданной длиной строки 5? 2)
